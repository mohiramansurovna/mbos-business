				...
				{sections.map((section, index) => {
					return (
						<motion.div
							...
							initial={'hidden'}
							className='absolute flex md:flex-row flex-col justify-center gap-2 items-center md:pl-44 py-10 pt-28 md:pt-10 mx-12'
						>
							<div className='flex flex-col items-start gap-2'>
								...
								<Button
									...
									className='mt-[1.6rem] mx-2 z-50 bg-[#166cc8]/10 border border-[#166cc8]'
								>
									{t.services.button}
								</Button>
							</div>
