		...
		<>
			...
			<header
				...
				className={`transition-all duration-300
                    ...
                    fixed z-50 w-3/5 md:w-full bg-black/30 md:bg-black/20 text-lg md:text-mm  backdrop-blur-xl md:backdrop-blur-sm flex flex-col md:flex-row justify-start pt-20 md:pt-0 md:justify-around items-center h-screen md:h-25 overflow-hidden text-white`}
			>
				<Link onClick={handleMenu} href='#home'>
					<Image
						src='/logo.svg'
				...
				<nav className='flex flex-col text-[18px] font-light items-start md:flex-row gap-1 md:gap-3'>
					<Link
						onClick={handleMenu}
						href='#home'
